...
## Details
This program utilizes a Convolutional Neural Network to achieve the goal. In this CNN, hiden layers contain two convolution layers, two max pooling layers and two fully connected layers.
